...
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -target amd64,arm64 bpf ../../../../bpf/go_gc.c  -- -I../../../../bpf/headers
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -target amd64,arm64 bpf_debug ../../../../bpf/go_gc.c -- -I../../../../bpf/headers -DBPF_DEBUG
...
func (p *Tracer) GoProbes() map[string]ebpfcommon.FunctionPrograms {
	return map[string]ebpfcommon.FunctionPrograms{
		"runtime.stopTheWorldWithSema": {
			Start: p.bpfObjects.UprobeRuntimeStopTheWorldWithSema,
		},
...
func (p *Tracer) Run(ctx context.Context, eventsChan chan<- []request.Span, service svc.ID) {
	logger := slog.With("component", "gogc.Tracer")
