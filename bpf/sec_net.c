...
// TODO: For now, overriding this to inspect everything.
#define valid_pid(x) valid_pid_sec((x))
static __always_inline u32 valid_pid_sec(u64 id) {
    u32 pid = id >> 32;
    //bpf_printk("pid: %u", pid); // XXX TEMP
    return pid;
}
